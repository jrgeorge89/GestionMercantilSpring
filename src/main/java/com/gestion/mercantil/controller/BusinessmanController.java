...
public class BusinessmanController {
    ...
    public ResponseEntity<ApiResponse<Page<Businessman>>> getAllBusinessmen(
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Comerciantes consultados exitosamente.", businessmen));
    }
    ...
    public ResponseEntity<ApiResponse<Businessman>> getBusinessmanById(@PathVariable Integer id) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Comerciante consultado exitosamente por ID.", businessman));
    }
...
//        System.out.println("Fecha al recibir respuesta: " + createdBusinessman.getFechaRegistro());
        return ResponseEntity.ok(new ApiResponse<>(true, "Comerciante creado exitosamente.", createdBusinessman));
    }
    ...
    public ResponseEntity<ApiResponse<Businessman>> updateBusinessman(@PathVariable Integer id, @RequestBody @Valid Businessman businessman) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Comerciante actualizado exitosamente.", updatedBusinessman));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> deleteBusinessman(@PathVariable Integer id) {
        businessmanService.delete(id);
        return ResponseEntity.ok(new ApiResponse<>(true, "Comerciante Eliminado exitosamente.", null));
    }
    ...
    public ResponseEntity<ApiResponse<Businessman>> updateBusinessmanStatus(@PathVariable Integer id, @RequestParam String status) {
        ...
        return ResponseEntity.ok(new ApiResponse<>(true, "Estado del Comerciante actualizado exitosamente.", updatedBusinessman));
    }
}
